...
def eval_score(set_type: str, file_path: str):
    ...
    if set_type == '3d':
        result['Delivery Rate'] = delivery_cnt / 344
        result['Commonsense Constraint Micro Pass Rate'] = constraint_dis_record['commonsense']['pass'] / 3440
        result['Commonsense Constraint Macro Pass Rate'] = final_commonsense_cnt / 344
        result['Hard Constraint Micro Pass Rate'] = constraint_dis_record['hard']['pass'] / 813  
        result['Hard Constraint Macro Pass Rate'] = final_hardConstraint_cnt / 344
        result['Final Pass Rate'] = final_all_cnt / 344

    elif set_type == '5d':
        result['Delivery Rate'] = delivery_cnt / 324
        result['Commonsense Constraint Micro Pass Rate'] = constraint_dis_record['commonsense']['pass'] / 3240
        result['Commonsense Constraint Macro Pass Rate'] = final_commonsense_cnt / 324
        result['Hard Constraint Micro Pass Rate'] = constraint_dis_record['hard']['pass'] / 846 
        result['Hard Constraint Macro Pass Rate'] = final_hardConstraint_cnt / 324
        result['Final Pass Rate'] = final_all_cnt / 324

    elif set_type == '7d':
        result['Delivery Rate'] = delivery_cnt / 332
        result['Commonsense Constraint Micro Pass Rate'] = constraint_dis_record['commonsense']['pass'] / 3320
        result['Commonsense Constraint Macro Pass Rate'] = final_commonsense_cnt / 332
        result['Hard Constraint Micro Pass Rate'] = constraint_dis_record['hard']['pass'] / 806
        result['Hard Constraint Macro Pass Rate'] = final_hardConstraint_cnt / 332
        result['Final Pass Rate'] = final_all_cnt / 332
