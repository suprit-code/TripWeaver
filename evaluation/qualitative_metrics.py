...
attractions_data = pd.read_csv('D:\\BTP\\TripCraft-1\\TripCraft_database\\attraction\\cleaned_attractions_final.csv')
...
if __name__ == '__main__':
    ...
    with open(gen_file_path, 'r', encoding='utf-8') as file1, open(anno_jsonl_file_path, 'r', encoding='utf-8') as file2:
        for line1, line2 in zip(file1, file2):
            ...
            if json_object1["plan"] == "" or json_object1["plan"][0]["days"] == 0:
                metrics_list.append({"temporal_score": -1, "spatial_score": -1, "ordering_score": -1, "persona_score": -1})
            else:
                metrics_list.append({"temporal_score": calculate_temporal_score(json_object1), "spatial_score": calculate_spatial_score(json_object1), "ordering_score": calculate_ordering_score(json_object1,json_object2), "persona_score": calculate_persona_score(json_object1)})
